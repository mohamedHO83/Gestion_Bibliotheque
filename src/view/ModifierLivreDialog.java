...
public class ModifierLivreDialog extends JFrame {
    ...
    public ModifierLivreDialog(BiblioView x, Livre l){
        titre.setText(l.getTitre());
        autheur.setText(l.getAuteur());
        annee.setText(Integer.toString(l.getAnneepub()));
        genre.setText(l.getGenre());
        nbCopies.setText(Integer.toString(l.getNbCopies()));
